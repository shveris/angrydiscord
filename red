...
body {
    ...
    --dms-icon-svg-url: url('https://github.com/shveris/shadow-themed-vencord.css/blob/543184937bd7a656171d6ad2e880fac5e82d6bc0/shadow-icon.svg'); /* icon svg url. MUST BE A SVG. */
...
:root {
    ...
    /* background and dark colors */
	  --bg-1: hsl(330, 15%, 20%); /* dark buttons when clicked */
	  --bg-2: hsl(330, 15%, 16%); /* dark buttons */
	  --bg-3: hsl(330, 15%, 13%); /* spacing, secondary elements */
	  --bg-4: hsl(330, 15%, 10%); /* main background color */
    ...
    --online-indicator: hsl(145, 57%, 55%); /* change to #23a55a for default green */
